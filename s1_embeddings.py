...
CONFIG = {
    # Dataset roots
    "data_root": "/scratch/saigum/algonauts_2025.competitors",
    "video_input_folder": "/scratch/saigum/algonauts_2025.competitors/stimuli/movies/friends/s1",
    "fmri_root": "/scratch/saigum/algonauts_2025.competitors/fmri",
    "output_root": "/scratch/saigum/algonauts_outputs/s1_vjepa_decode_uniform10pct_oomfixed",
...
def build_vjepa_bundle(model_name, device, config):
    ...
    model = AutoModel.from_pretrained(model_name, dtype=model_dtype).to(device).eval()
